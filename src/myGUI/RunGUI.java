...
public class RunGUI extends Pane{
	...
	public void switchToTracker(String user) { 
		this.user = user;
		
		// Create trackerPage
	    trackerPage = new TrackerPage(this, user);
	    
	    // TODO: Wrap tracker with scroll pane
